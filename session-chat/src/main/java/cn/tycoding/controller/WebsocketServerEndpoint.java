...
public class WebsocketServerEndpoint {
    ...
    public void onMessage(String message) throws IOException {
        ...
        chatSessionService.pushMessage(fromId, null, messages, httpSession);

        //群发消息
        sendMore(getData(null, messages));
    }
     ...
     * @throws IOException
     */
    private String getData(String toId, Message entity) throws IOException {
        ...
        for (WebsocketServerEndpoint endpoint : websocketServerEndpoints) {
            try {
                if (toId == null) {
                    ...
                    endpoint.sendMessage(getData(toId, entity));
                    chatSessionService.pushMessage(fromId, toId, entity, httpSession);
                }
            } catch (Exception e) {
                e.printStackTrace();
                continue;
